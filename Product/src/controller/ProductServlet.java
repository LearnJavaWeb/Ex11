...
public class ProductServlet extends HttpServlet {
    ...
    private void createProduct(HttpServletRequest request,HttpServletResponse response)
    {
        ...
        Product product = new Product(id,name,gia,mota,made);
    ...
    private void showProductNew(HttpServletRequest request,HttpServletResponse response)
    {
        RequestDispatcher dispatcher = request.getRequestDispatcher("product/create.jsp");
    ...
    private void editProduct(HttpServletRequest request,HttpServletResponse response)
    {
        ...
        String name = request.getParameter("name");
        float gia = Float.parseFloat(request.getParameter("gia"));
        String mota = request.getParameter("gia");
        String made = request.getParameter("made");
        ...
        if (product== null){
            ...
            request.setAttribute("product",product);
            request.setAttribute("message","Da cap nhap thanh cong!!!");
